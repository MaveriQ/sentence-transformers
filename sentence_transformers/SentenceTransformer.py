...
class SentenceTransformer(nn.Sequential):
    ...
    def __init__(self, model_name_or_path: Optional[str] = None,
                 ...
                 **hf_kwargs, # Additional arguments for the Transformers model
                 ):
        ...
        if model_name_or_path is not None and model_name_or_path != "":
            ...
            if os.path.exists(os.path.join(model_path, 'modules.json')):    #Load as SentenceTransformer model
                ...
                modules = self._load_auto_model(model_path,**hf_kwargs)
    ...
    def _load_auto_model(self, model_name_or_path,**hf_kwargs):
        """
        ...
        transformer_model = Transformer(model_name_or_path, model_args=hf_kwargs, tokenizer_args=hf_kwargs)
